...
$(document).ready(function($){
	...
	// Close after clicking element in mobile view
	...
	function makeTimer() {
		...
		var endTime = new Date("1 September 2018 12:00:00 GMT+02:00");			
  ...
  $("#doughnutChart").drawDoughnutChart([
		{ title: "Marketing",					value : 2,	color: "#4daae9" },
		{ title: "Development",				value : 2,	color: "#121212" },
		{ title: "Exchange Listing",	value:  3,	color: "#ff5851" },
		{ title: "Proof of Work",			value : 85,	color: "#fabd24" },
    { title: "Proof of Stake",		value:  8,	color: "#a0cd5c" },
  ]);
});
/*!
